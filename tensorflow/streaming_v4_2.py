...
#def stream(x, name, training_mode=False):
    with tf.variable_scope(name) as scope:
        ...
        x_revised = py_func_with_grad(lambda x, s: s, [x, s_final], [tf.float32], name=name, grad=lambda op,grad: stream_gradient(op,grad,name,beta,kappa))
...
def stream_gradient(op, grad, name, beta, kappa):
    ...
    print "setting up stream_gradient .............." 
    return grad, grad*0  
